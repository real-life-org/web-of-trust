...
export function SpaceDetail() {
  ...
  // message clears the taller edge-to-edge bottom nav. --safe-bottom-nav is 0
  // at md+, where the nav is a sidebar and adds no bottom height.
  return (
    <div className="flex flex-col h-[calc(100dvh-env(safe-area-inset-top)-7.5rem-var(--safe-bottom-nav))]">

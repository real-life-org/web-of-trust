...
export type { CryptoAdapter, EncryptedPayload, } from './ports/CryptoAdapter';
...
export type { DiscoveryAdapter, ProfileResolveResult, PublicVerificationsData, PublicAttestationsData, ProfileSummary, } from './ports/DiscoveryAdapter';
